...
class GoogleTrendsWWW < MyCoolClass
	...
	def goog_main 
		...
		my_country_dict = get_woeids(countries_to_grab)
		puts my_country_dict.size
		...
		google_trends_file = "/home/ubuntu/tubes_trends/json_data/google/google_trends_" +grab_the_date+ "_" + letter_array[counter]+ ".json"
